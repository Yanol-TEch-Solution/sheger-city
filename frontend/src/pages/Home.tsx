      ...
      <div className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-50 flex flex-col items-center gap-3">
        ...
        <div className="flex flex-col items-center gap-3 mb-1">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="w-12 h-12 bg-red-500 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-red-600 transition-all group relative"
          >
        ...
        <button
          ...
          className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-tr from-red-600 to-red-700 text-white rounded-full shadow-[0_20px_50px_rgba(220,38,38,0.3)] z-50 flex items-center justify-center active:scale-90 transition-all border border-white/20 group relative overflow-hidden"
        >
          ...
          {/* Pulsing indicator */}
          <div className="absolute top-4 right-4 w-4 h-4 bg-red-500 border-2 border-red-600 rounded-full">
