      ...
      <div className="bg-slate-50 min-h-screen py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Explore Our Sub Cities</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {subCityKeys.map((key, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">{t(`subcities.${key}`)}</h3>
    ...
    <div className="py-16 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold mb-4">{currentSubCityName}</h1>
