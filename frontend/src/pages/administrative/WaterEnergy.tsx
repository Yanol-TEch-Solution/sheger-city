    ...
    <div className="bg-slate-50 min-h-screen text-slate-800 font-sans overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-semibold text-base tracking-tight text-slate-900 font-display">{t('administrative_options.water_energy')}</span>
            </div>
          </div>
      ...
      <section className="relative pt-28 pb-20 lg:pt-32 lg:pb-32 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-red-600 to-red-500 opacity-30 mix-blend-multiply z-10"></div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-slate-600 font-sans text-base">Discover the ongoing projects and transformative programs led by the Water & Energy to modernize our city.</p>
            </div>
            ...
            {[1, 2].map((i) => (
              <motion.div key={i} {...fadeUp} className="group cursor-pointer">
                <div className="relative h-64 rounded-[2rem] overflow-hidden mb-6 bg-slate-200 shadow-md">
                  <div className="absolute inset-0 bg-gradient-to-tr from-red-600 to-red-500 opacity-30 mix-blend-multiply group-hover:opacity-10 transition-opacity z-10"></div>
            ...
            <div>
              ...
              <div className="flex items-center gap-6 p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-xs font-sans text-red-200 mb-3">Head of Water & Energy</p>
      ...
      <footer id="contact" className="bg-red-950 py-16 px-6 border-t border-red-900 text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <h4 className="font-semibold font-display text-xl mb-4">{t('administrative_options.water_energy')}</h4>
