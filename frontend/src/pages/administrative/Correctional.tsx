        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-semibold text-lg tracking-tight text-slate-900 font-display">{t('administrative_options.correctional')}</span>
            </div>
          </div>
      ...
      <footer id="contact" className="bg-slate-950 py-16 px-6 border-t border-slate-900 text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <h4 className="font-semibold font-display text-2xl mb-4">{t('administrative_options.correctional')}</h4>
