        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-semibold text-lg tracking-tight text-slate-900 font-display">Security</span>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-slate-600 font-sans text-lg">Discover the ongoing projects and transformative programs led by the Security to modernize our city.</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-red-100/80 text-lg leading-relaxed mb-8 font-sans">
                Under the guidance of our experienced directors and administrative heads, the Security is committed to ethical governance, rapid innovation, and public accountability.
              </p>
              ...
              <div className="flex items-center gap-6 p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors">
                <div className="w-20 h-20 rounded-full bg-red-800 overflow-hidden shrink-0 border-2 border-white/20">
                  <img src="https://picsum.photos/seed/security-mayor/400/400" alt="Director" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h4 className="text-xl font-semibold font-display mb-1">Ato / W/ro Director Name</h4>
                  <p className="text-sm font-sans text-red-200 mb-3">Head of Security</p>
                  <div className="flex items-center gap-3">
                    ...
                    <button className="text-sm font-medium font-sans hover:text-white text-red-100 transition-colors">Read Full Bio</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer id="contact" className="bg-red-950 py-16 px-6 border-t border-red-900 text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <h4 className="font-semibold font-display text-2xl mb-4">Security</h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-red-200/60 font-sans">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info_security@shegercity.gov.et</span>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto border-t border-red-800/50 mt-12 pt-8 text-center text-red-200/40 font-sans text-sm">
          &copy; {new Date().getFullYear()} Security, Sheger City Administration. All rights reserved.
        </div>
      </footer>
