        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-semibold text-base tracking-tight text-slate-900 font-display">{t('administrative_options.education')}</span>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-slate-600 font-sans text-base">Discover the ongoing projects and transformative programs led by the Education Office to modernize our city.</p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-6 p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-xs font-sans text-red-200 mb-3">Head of Education Office</p>
      ...
      <footer id="contact" className="bg-red-950 py-16 px-6 border-t border-red-900 text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <h4 className="font-semibold font-display text-xl mb-4">{t('administrative_options.education')}</h4>
