    ...
    <div className="bg-slate-50">
      ...
      <section className="py-24 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeUp(0)}>
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-red-500 mb-4">{t('about_page.overview_badge')}</p>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-6">{t('about_page.overview_p1')}</p>
            ...
            <motion.div {...fadeUp(0.2)} className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-5 shadow-xl border border-slate-100 hidden sm:block">
                <div className="text-2xl font-semibold text-red-600 font-display">Est. 2021</div>
      ...
      <section className="py-24 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div {...fadeUp(0)} className="text-center mb-16">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-red-400 mb-4">{t('about_page.vision_badge')}</p>
            <h2 className="text-4xl sm:text-5xl font-bold font-display tracking-tight">{t('about_page.vision_title')}</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div {...fadeUp(0.1)} className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-10 hover:bg-white/10 transition-all">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 font-display">{t('about_page.our_vision')}</h3>
              <p className="text-white/70 leading-relaxed text-lg">{t('about_page.vision_text')}</p>
            </motion.div>
            ...
            <motion.div {...fadeUp(0.2)} className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-10 hover:bg-white/10 transition-all">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 font-display">{t('about_page.our_mission')}</h3>
              <p className="text-white/70 leading-relaxed text-lg">{t('about_page.mission_text')}</p>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-white border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp(0)} className="text-center mb-16">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-red-500 mb-4">{t('about_page.journey_badge')}</p>
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 font-display tracking-tight">{t('about_page.journey_title')}</h2>
          </motion.div>
            ...
            {TIMELINE.map((item, i) => (
              <motion.div key={item.year} {...fadeUp(i * 0.1)} className={`relative flex flex-col sm:flex-row items-start sm:items-center mb-14 ${i % 2 !== 0 ? "sm:flex-row-reverse" : ""}`}>
                <div className={`sm:w-5/12 w-full pl-14 sm:pl-0 ${i % 2 !== 0 ? "sm:pl-10" : "sm:pr-10 sm:text-right"}`}>
                  <span className="text-xs font-semibold uppercase tracking-[0.25em] text-red-500">{item.year}</span>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp(0)} className="text-center mb-16">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-red-500 mb-4">{t('about_page.milestones_badge')}</p>
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 font-display tracking-tight">{t('about_page.milestones_title')}</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {ACHIEVEMENTS.map((a, i) => (
              <motion.div key={a.title} {...fadeUp(i * 0.08)} whileHover={{ y: -6 }} className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm hover:shadow-xl transition-all duration-300 group">
                ...
                <div className="text-4xl font-semibold text-red-600 font-display mb-2">{a.stat}</div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div {...fadeUp(0)}>
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-red-500 mb-6">{t('about_page.get_involved')}</p>
            <h2 className="text-4xl sm:text-6xl font-bold text-slate-900 font-display tracking-tight mb-6 leading-tight">{t('about_page.future_title')}</h2>
            <p className="text-slate-600 text-xl leading-relaxed mb-10 max-w-2xl mx-auto">{t('about_page.future_desc')}</p>
