      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 bg-slate-50/65 relative overflow-hidden z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative">
            ...
            <svg 
              className="absolute top-1/2 left-0 right-0 -translate-y-1/2 w-full h-auto pointer-events-none hidden lg:block opacity-20"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-6">
              {[
                ...
                <motion.div
                  ...
                  className={`group relative bg-white p-6 sm:p-8 rounded-2xl sm:rounded-[2rem] border border-slate-100 shadow-lg hover:shadow-2xl hover:shadow-red-500/20 transition-all flex flex-col h-full ${service.position}`}
                >
                  {/* Curved Top Accent */}
                  <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-24 h-2 bg-gradient-to-r from-transparent via-red-500 to-transparent rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
                  ...
                  <Link 
                    ...
                    className="mt-auto w-full py-2.5 sm:py-3 text-center text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-slate-700 border border-slate-100 rounded-lg sm:rounded-xl hover:bg-red-600 hover:text-white hover:border-red-600 transition-all group-hover:shadow-lg"
                  >
